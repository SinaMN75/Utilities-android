...
public ArcProgress(Context context,AttributeSet attrs,int defStyleAttr){
	...
	default_text_size=new Util().spToPx(getResources(),40);
	default_suffix_text_size=new Util().spToPx(getResources(),15);
	default_suffix_padding=new Util().dpToPx(getResources(),4);
	default_suffix_text="%";
	default_bottom_text_size=new Util().spToPx(getResources(),10);
	default_stroke_width=new Util().dpToPx(getResources(),4);
