...
public class ArcProgress extends View {
    ...
    protected void initByAttributes(TypedArray attributes) {
        ...
        suffixText =
                TextUtils.isEmpty(attributes.getString(R.styleable.ArcProgress_arc_suffix_text)) ? default_suffix_text
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        rectF.set(
                strokeWidth / 2f,
                strokeWidth / 2f, width - strokeWidth / 2f, MeasureSpec.getSize(heightMeasureSpec) - strokeWidth / 2f);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(getBottomText())) {
            ...
            canvas.drawText(getBottomText(),
                    (getWidth() - textPaint.measureText(getBottomText())) / 2.0f, bottomTextBaseline, textPaint);
        }
    }
