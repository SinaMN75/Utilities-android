...
public class SwitchButton extends View implements Checkable{
    ...
    @TargetApi(Build.VERSION_CODES.LOLLIPOP) public SwitchButton(Context context,AttributeSet attrs,int defStyleAttr,int defStyleRes){
    ...
    @Override public final void setPadding(int left,int top,int right,int bottom){
    ...
    @Override protected void onSizeChanged(int w,int h,int oldw,int oldh){
        ...
        float width=w-viewPadding-viewPadding;
    ...
    @Override public final void setOnLongClickListener(OnLongClickListener l){
    }
