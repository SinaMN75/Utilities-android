...
@SuppressLint("DefaultLocale") object CountryUtils {
	 ...
	 * @return the country
	 */
	private val countryBySim: String
		get() {
	 ...
	 * @return the country
	 */
	private val countryByLanguage: String get() = Resources.getSystem().configuration.locale.country
	
	private val countryCodeFromMap: HashMap<String, String>
		get() {
			if (countryCodeMap == null) {
				countryCodeMap = HashMap(256)
	 ...
	 */
	fun getCountryCodeBySim(defaultValue: String): String = countryCodeFromMap[countryBySim] ?: defaultValue
	 ...
	 * @return the country code
	 */
	fun getCountryCodeByLanguage(defaultValue: String): String = countryCodeFromMap[countryByLanguage] ?: defaultValue
}