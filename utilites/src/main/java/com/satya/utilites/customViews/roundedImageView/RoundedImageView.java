...
public class RoundedImageView extends AppCompatImageView {
	...
	private static final ScaleType[] SCALE_TYPES = {ScaleType.MATRIX, ScaleType.FIT_XY,
	                                                ScaleType.FIT_START, ScaleType.FIT_CENTER,
	                                                ScaleType.FIT_END, ScaleType.CENTER,
	                                                ScaleType.CENTER_CROP, ScaleType.CENTER_INSIDE};
	private final float[] mCornerRadii = new float[]{DEFAULT_RADIUS, DEFAULT_RADIUS, DEFAULT_RADIUS,
	                                                 DEFAULT_RADIUS};
	...
	private void updateBackgroundDrawableAttrs(boolean convert) {
		if (mMutateBackground) {
			if (convert) mBackgroundDrawable = RoundedDrawable.fromDrawable(mBackgroundDrawable);
	...
	public void setBorderColor(ColorStateList colors) {
		...
		mBorderColor = (colors != null) ? colors
