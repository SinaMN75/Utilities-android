...
public class RoundedDrawable extends Drawable {
	...
	private void updateShaderMatrix() {
		...
		switch (mScaleType) {
			case CENTER:
				...
				mShaderMatrix.reset();
				mShaderMatrix.setTranslate((int) ((mBorderRect.width() - mBitmapWidth) * 0.5f +
				                                  0.5f), (int) (
			...
			case CENTER_CROP:
				...
				mShaderMatrix.postTranslate(
						(int) (dx + 0.5f) + mBorderWidth / 2, (int) (dy + 0.5f) + mBorderWidth / 2);
				break;
			case CENTER_INSIDE:
				mShaderMatrix.reset();
	...
	RoundedDrawable setBorderColor(@ColorInt int color) {
	...
	RoundedDrawable setScaleType(ScaleType scaleType) {
	...
	void setTileModeY(Shader.TileMode tileModeY) {
