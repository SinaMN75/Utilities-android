...
fun Activity.dialogInfo(title: String, message: String, showAgain: Boolean = false, notShowAgainId: Int = 0, icon: Int = R.drawable.circle, topColor: Int = R.color.colorPrimary) {
...
fun Activity.dialogSingleChoice(title: String, message: String, items: ArrayList<String>, onItemSelected: LovelyChoiceDialog.OnItemSelectedListener<String>, icon: Int = R.drawable.circle, topColor: Int = R.color.colorPrimary) {
...
fun Activity.dialogMultiChoice(title: String, message: String, list: ArrayList<String>, onItemSelected: LovelyChoiceDialog.OnItemsSelectedListener<String>, buttonTitle: String = "OK", icon: Int = R.drawable.circle, topColor: Int = R.color.colorPrimary) {
	LovelyChoiceDialog(this)
		.setTopColorRes(topColor)
		.setMessage(message)
		.setTitle(title)
...
fun Activity.dialogInput(title: String, message: String, onTextInputConfirmListener: LovelyTextInputDialog.OnTextInputConfirmListener, icon: Int = R.drawable.circle, topColor: Int = R.color.colorPrimary) {
